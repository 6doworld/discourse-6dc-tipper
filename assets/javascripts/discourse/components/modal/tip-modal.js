...
export default class TipModalComponent extends Component {
    @service dialog;
    @service modal;
    ...
    async didInsertElement() {
        this.set("sampleValues", this.utils.intermediateValues(
            this.siteSettings.minimum_tip,
            this.siteSettings.maximum_tip,
            6
        ).filter(v => {
            ...
            if (tx) {
                ...
                if (status && transaction) {
                    ...
                    this.dialog.alert({
                        ...
                        didConfirm: () => { this.closeModal(); stopConfetti(); },
                        didCancel: () => { this.closeModal(); stopConfetti(); },
                    });
                }
            }
        } catch (err) {
